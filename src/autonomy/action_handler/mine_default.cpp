    ...
    namespace action_handler
    {
        ...
        void mine_default::execute( entity::asteroid & entity )
        {
            for(auto& mine_act : _action_group)
            {
                ...
                (mine_act->subject())->send_action<actor::mine_response>(fuel_obtained);
        ...
        void mine_location_default::execute( entity::universe & entity )
        {
            ...
            for(auto& mine_loc : _action_group)
            {
                ...
                {
                    object->send_action<actor::mine>(mine_loc->fuel(), mine_loc->subject());
                }
                else
                {
                    mine_loc->subject()->send_action<actor::mine_response>(0);
                }
            }
