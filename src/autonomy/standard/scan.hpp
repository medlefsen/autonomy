...
#include <autonomy/standard/scan.fwd.hpp>
...
namespace autonomy { namespace standard
{
    ...
    : public action_base<universe>
  {
    public:
      ...
      {
        return action_handler_id_t(static_cast<scan_default*>(NULL));
      }
    ...
    : public action_base<scripted_drone>
  {
    public:
      ...
      virtual action_handler_id_t default_handler_type() const
      {
        return action_handler_id_t(static_cast<scan_response_default*>(NULL));
      }
