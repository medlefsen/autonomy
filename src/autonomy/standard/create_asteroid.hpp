...
#include <autonomy/standard/create_asteroid.fwd.hpp>
...
namespace autonomy { namespace standard
{
    ...
    : public action_base<universe>
  {
    ...
    {}
      ...
      {
        return action_handler_id_t(static_cast<create_asteroid_default*>(NULL));
      }
    ...
    : public action_base<drone>
  {
    public:
      ...
      virtual action_handler_id_t default_handler_type() const
      {
        return action_handler_id_t(static_cast<create_asteroid_response_default*>(NULL));
      }
